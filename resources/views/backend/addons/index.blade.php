    ...
    <div class="">
        <div class="row ">
			...
			{{-- <div class="col mt-3 mt-md-0 text-center text-md-right">
                <a href="https://##/activation/addon" class="btn btn-primary" target="_blank">
					{{ translate('Activate Addon Link') }}
				</a>
            </div> --}}
            <div class="col mt-3 mt-md-0 text-center text-md-right">
                <a href="https://##/activation/addon" class="btn btn-primary mb-3 mb-sm-0 mx-3 mx-md-0 mr-lg-3" target="_blank">
					{{ translate('Activate Addon Link') }}
				</a>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $.post('https://##/addons/public/addons', {item: 'ecommerce'}, function(data){
                //console.log(data);
                html = '';
                data.forEach((item, i) => {
                    if(item.link != null){
