...
<div class="aiz-demo-nav">
    ...
    <div class="aiz-demo-nav-links">
        <a href="https://#/docs/active-ecommerce-cms/" class="aiz-demo-nav-item" target="_blank">
            ...
            <div class="row gutters-16">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-grocery/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-electronics/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-fashion/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-automobile/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-furniture/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-medical/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-sports/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-construction/" target="_blank" class="h-100 w-100">
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.#/ecommerce-megamart/" target="_blank" class="h-100 w-100">
